...
function instance($$self, $$props, $$invalidate) {
	...
	const deleteFavorite = () => {
		!(function webpackMissingModule() { var e = new Error("Cannot find module '../s'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).collection("favorites").doc(favorite.name).delete().then(function () {
	...
	$$self.$capture_state = () => ({ db: !(function webpackMissingModule() { var e = new Error("Cannot find module '../s'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), favoritesCountry, deleteFavorite });
