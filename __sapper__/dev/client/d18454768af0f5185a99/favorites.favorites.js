...
/* harmony import */ var _firestore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../firestore */ "./src/firestore.js");
...
function add_css() {
	...
	style.textContent = "section.svelte-3it9jd{display:grid;grid-template-columns:auto 1fr 1fr auto auto;gap:1rem;padding:1rem;align-items:center;border-bottom:1px solid #ccc\n    }\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div0, file, 19, 8, 389);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div1, file, 20, 8, 432);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div2, file, 21, 8, 479);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div3, file, 22, 8, 523);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(button, file, 23, 8, 571);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(section, "class", "svelte-3it9jd");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(section, file, 18, 4, 371);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const deleteFavorite = () => {
		_firestore__WEBPACK_IMPORTED_MODULE_1__["db"].collection("favorites").doc(favorite.name).delete().then(function () {
	...
	$$self.$capture_state = () => ({ db: _firestore__WEBPACK_IMPORTED_MODULE_1__["db"], favoritesCountry, deleteFavorite });
