...
function add_css() {
	...
	style.id = "svelte-t7ta8u-style";
	style.textContent = "section.svelte-t7ta8u{display:grid;grid-template-columns:2fr 1fr 1fr 1fr 1fr;gap:1rem;padding:1rem;align-items:center;border-bottom:1px solid #ccc;color:white;width:80vw\n        just}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(section, "class", "svelte-t7ta8u");
...
class Favorite extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-t7ta8u-style")) add_css();
