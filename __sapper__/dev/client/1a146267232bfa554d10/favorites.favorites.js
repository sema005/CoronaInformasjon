...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$set = $$props => {
		if ("fa" in $$props) $$invalidate(0, fa = $$props.fa);
	};
...
class Favorite extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["init"])(this, options, instance, create_fragment, svelte_internal__WEBPACK_IMPORTED_MODULE_0__["safe_not_equal"], { fa: 0 });
		...
		if (/*fa*/ ctx[0] === undefined && !("fa" in props)) {
			console.warn("<Favorite> was created without expected prop 'fa'");
		}
	}
